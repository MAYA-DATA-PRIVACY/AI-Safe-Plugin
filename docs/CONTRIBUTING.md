...
Thanks for taking the time to contribute. AI-Safe Plugin is a privacy tool, so anything that hardens security, catches more kinds of PII, or makes the extension easier to live with is especially welcome.
